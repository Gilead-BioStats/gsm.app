            ...
            <div class="main bslib-gap-spacing html-fill-container">
              <main class="bslib-page-main bslib-gap-spacing html-fill-item html-fill-container">
                <div class="tab-content html-fill-item html-fill-container" data-tabsetid="XXXX">
                  <div class="tab-pane active html-fill-item html-fill-container bslib-gap-spacing" data-value="Study Overview" id="tab-XXXX-1" style="--bslib-navbar-margin:0;">
                    <div class="tabbable">
                      ...
                      <div class="tab-content" data-tabsetid="XXXX">
                        <div class="tab-pane active html-fill-item html-fill-container bslib-gap-spacing" data-value="Overview Table" id="tab-XXXX-1" style="--bslib-navbar-margin:0;">
                        ...
                        <div class="tab-pane html-fill-item html-fill-container bslib-gap-spacing" data-value="Scatter Plots" id="tab-XXXX-2" style="--bslib-navbar-margin:0;">
                  ...
                  <div class="tab-pane html-fill-item html-fill-container bslib-gap-spacing" data-value="Metric Details" id="tab-XXXX-2" style="--bslib-navbar-margin:0;">
                    <div class="tabbable">
                      ...
                      <div class="tab-content" data-tabsetid="XXXX">
                        <div class="tab-pane active html-fill-item html-fill-container bslib-gap-spacing" data-value="Scatter Plot" id="tab-XXXX-1" style="--bslib-navbar-margin:0;">
                        ...
                        <div class="tab-pane html-fill-item html-fill-container bslib-gap-spacing" data-value="Bar Chart (KRI Value)" id="tab-XXXX-2" style="--bslib-navbar-margin:0;">
                        ...
                        <div class="tab-pane html-fill-item html-fill-container bslib-gap-spacing" data-value="Bar Chart (KRI Score)" id="tab-XXXX-3" style="--bslib-navbar-margin:0;">
                          <div class="card mb-3" style="margin-top: 4px;">
                            <div class="card-body">
                        ...
                        <div class="tab-pane html-fill-item html-fill-container bslib-gap-spacing" data-value="Time Series" id="tab-XXXX-4" style="--bslib-navbar-margin:0;">
                          <div class="card mb-3" style="margin-top: 4px;">
                            <div class="card-body">
                        ...
                        <div class="tab-pane html-fill-item html-fill-container bslib-gap-spacing" data-value="Analysis Output" id="tab-XXXX-5" style="--bslib-navbar-margin:0;">
                  ...
                  <div class="tab-pane html-fill-item html-fill-container bslib-gap-spacing" data-value="Participant Details" id="tab-XXXX-3" style="--bslib-navbar-margin:0;">
                    <div class="row">
                      <div class="col-sm-6">
