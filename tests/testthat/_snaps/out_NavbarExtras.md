# out_NavbarExtras generates the expected UI

    Code
      test_result
    Output
      [[1]] <li class="bslib-nav-item nav-item form-inline inline-select" id="group-level">
      ...
      </li> [[2]] <li class="bslib-nav-item nav-item form-inline inline-select" id="group-group">
      <div class="form-group shiny-input-container shiny-input-container-inline">
      ...
      </li> [[3]] <li class="bslib-nav-item nav-item form-inline inline-select" id="participant">
      <div class="form-group shiny-input-container shiny-input-container-inline">
