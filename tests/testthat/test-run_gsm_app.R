# This set of tests is slow, and requires that the package be *installed* before
# running.
#
# Run these lines before running the test. Test just this one file, most likely.
