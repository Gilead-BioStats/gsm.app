    ...
    div(
      ...
      shiny::tabsetPanel(
        shiny::tabPanel(
          "Site Overview",
          div(
            class = "col-12 col-sm-12 col-md-12 col-lg-8 col-xxl-6",
            div(
              class = "row",
              div(
                class = "col-12 col-sm-6 col-md-6 col-lg-6 col-xxl-6",
                div(
              ...
              div(
                class = "col-12 col-sm-6 col-md-6 col-lg-6 col-xxl-6",
                div(
                  id = ns("card_placeholder_participant_status"),
                  class = "card mb-3",
                  style = "border-top: solid #0dcaf0",
                  div(
                    class = "card-body",
