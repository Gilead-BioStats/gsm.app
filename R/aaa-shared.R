...
#' @param lPluginDefinition `list` A named list with required elements `meta`
#'   and `shiny`, and optional fields `spec`, `packages` and `required_inputs`.
#'   Usually generated by [plugin_Read()].
