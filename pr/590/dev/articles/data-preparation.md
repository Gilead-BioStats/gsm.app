...
[gsm.kri](https://github.com/Gilead-Public/gsm.kri), and
...
2.  [Create Mapping
    ...
    [gsm.mapping](https://github.com/Gilead-Public/gsm.mapping) provides
    necessary functions and workflows to perform the data transformation
    from raw/source datasets to appropriate domains. The gsm.app is
    designed to be flexible to accept data conforming to the
